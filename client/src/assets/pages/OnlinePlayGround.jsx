...
function OnlinePlayGround() {
  ...
  useEffect(() => {
    ...
    async function getPlayersData() {
      await axios
        .post("http://localhost:3000/api/getroomInfo", { roomcode })
        .then((res) => {
          if (res.data) {
  ...
  return (
    <main className="online-ground-main-container">
      <div className="player1-container player-name-container">
        <div className={`name-and-score-div ${isMyTurn ? "myturn-boder" : ""}`}>
          <h2>{playersData.player1}</h2>
